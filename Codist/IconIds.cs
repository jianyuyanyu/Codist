...
static class IconIds
{
	...
	public const int SyncActiveFile = KnownImageIds.LockedLink;
	...
	public const int TagOverline = KnownImageIds.TopBorder;
	...
	public const int EmptyFolder = KnownImageIds.FolderOpened;
	...
	#endregion
	#region file types
	public const int ASMFile = KnownImageIds.ASMFile;
	public const int CFile = KnownImageIds.CFile;
	public const int CSFileNode = KnownImageIds.CSFileNode;
	public const int CSProjectNode = KnownImageIds.CSProjectNode;
	...
	public const int VBFileNode = KnownImageIds.VBFileNode;
	public const int VBProjectNode = KnownImageIds.VBProjectNode;
	public const int PYFileNode = KnownImageIds.PYFileNode;
	public const int PYProjectNode = KnownImageIds.PYProjectNode;
	public const int TSFileNode = KnownImageIds.TSFileNode;
	public const int TSProjectNode = KnownImageIds.TSProjectNode;
	public const int CPPFileNode = KnownImageIds.CPPFileNode;
	public const int CPPProjectNode = KnownImageIds.CPPProjectNode;
	public const int CursorFile = KnownImageIds.CursorFile;
	public const int CPPHeaderFile = KnownImageIds.CPPHeaderFile;
	public const int DatabaseFile = KnownImageIds.DatabaseFile;
	...
	public const int SymlinkFile = KnownImageIds.SymlinkFile;
	public const int TifFile = KnownImageIds.TIFFile;
	...
	public const int ExecutableFile = KnownImageIds.Win32Application;
	public const int ConsoleFile = KnownImageIds.Console;
	public const int CrashDumpFile = KnownImageIds.CrashDumpFile;
	public const int BackupFile = KnownImageIds.FileGroupDefault;
	public const int IntermediateFile = KnownImageIds.Snippet;
	public const int AccessFile = KnownImageIds.OfficeAccess2013;
	public const int ExcelFile = KnownImageIds.OfficeExcel2013;
	public const int OutlookFile = KnownImageIds.OfficeOutlook2013;
	public const int PowerPointFile = KnownImageIds.OfficePowerPoint2013;
	public const int ProjectFile = KnownImageIds.OfficeProject2013;
	public const int VisioFile = KnownImageIds.OfficeVisio2013;
	public const int WordFile = KnownImageIds.OfficeWord2013;
	public const int CompressedFile = KnownImageIds.Package;
	public const int CompiledHelpFile = KnownImageIds.CompiledHelpFile;
